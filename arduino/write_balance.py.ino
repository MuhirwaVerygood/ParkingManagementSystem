...
void loop() {
  ...
  // Verify the UID
  byte expectedUID[] = {0x23, 0x5F, 0x87, 0xF5};  // Update this with the actual UID of your card
  bool uidMatch = true;
  ...
  if (!uidMatch) {
    Serial.println("This card's UID does not match 23 5F 87 F5. Aborting write.");
    rfid.PICC_HaltA();
